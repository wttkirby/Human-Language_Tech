...
def webcrawler(url, file):
    ...
    for curlink in soup.find_all('a'):
        ...
        if 'Nano' in link_str or 'nano' in link_str:
...
if __name__ == '__main__':
    ...
    url = 'https://www.google.com/search?q=nanotech&rlz=1C1ONGR_enUS1027US1027&sxsrf=AJOqlzVJGMMpiT6aulqCLVqWMBSiupIwNg%3A1678564615190&ei=B90MZJGJC8-rqtsPkp6VyAU&ved=0ahUKEwjRqPu81NT9AhXPlWoFHRJPBVkQ4dUDCBA&uact=5&oq=nanotech&gs_lcp=Cgxnd3Mtd2l6LXNlcnAQAzIECCMQJzIECCMQJzIICAAQgAQQsQMyCAgAEIAEELEDMgQIABADMgoIABCABBAUEIcCMggILhCABBDUAjIFCAAQgAQyBQgAEIAEMgUIABCABDoECAAQRzoGCAAQFhAeSgQIQRgAUOIHWK8PYOYTaABwAngAgAFOiAHEA5IBATeYAQCgAQHIAQjAAQE&sclient=gws-wiz-serp'

    # This will save all of the urls found by the crawler
    with open('urls2.txt', 'w', encoding='utf-8') as wFile:
    ...
    with open('filename2.txt', 'w', encoding='utf-8') as wFile:
