...
if __name__ == '__main__':
    ...
    with open('filename1.txt', 'r', encoding='utf-8') as rfile:
    ...
    frida_dict, frida_line = dictmaker(file_names, stopwords)
    importantTerm(frida_dict)
    important_terms = ['art', 'disability', 'health', 'inspiration', 'inspired', 'lovers', 'religion',
                       'flowers', 'portrait', 'selfportrait', 'fought']
    info_dict = {}
    # This is creating the knowledge base needed for the chatbot being created later
    for term in important_terms:
        info_dict[term] = findSent(term, frida_line)

    pickle.dump(info_dict, open('frida.pickle', 'wb'))
